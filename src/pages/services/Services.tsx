  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <PageHeader
        ...
        subTitle="আপনার সকল প্রয়োজনের জন্য আমরা বিশ্বস্ত, দ্রুত এবং প্রফেশনাল সেবা প্রদান করি।
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              <h2 className="text-3xl font-bold mb-6">
                আপনার প্রয়োজনীয় সেবা খুঁজে পাননি?
              </h2>
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                আমাদের সাথে যোগাযোগ করুন। আমরা আপনার সকল প্রয়োজনের জন্য
                কাস্টমাইজড সলিউশন প্রদান করি।
              </p>
