    ...
    return (
         <div 
                    ...
                    >
                     ...
                     <img src={service.image} alt={service?.name} className="w-full h-[200px] object-cover rounded-t-md" />
                     </div>
        
                     <div className="p-6">
                      <h3 className="text-xl font-medium mb-2 text-primary">{service.name}</h3>
                      ...
                      <div className="absolute inset-0 flex flex-col   items-center justify-center text-center px-6 bg-primary text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        ...
                        <div>
                          <Link to={`/services/${service?._id}`} className="bg-white text-primary hover:bg-gray-100 font-medium py-3 px-8 rounded-lg transition-colors duration-200 inline-flex items-center gap-2">
                          বিস্তার করুন
                          </Link>
                        </div>
                      </div>
